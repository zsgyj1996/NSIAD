...
class NSIAD(BaseModel,DataExtractor):
    '''
...
#         print(x[0].shape,x[1].shape)
        ...
        if save_best_only:
            checkpoint_path = tempfile.gettempdir()+'/NSIAD.ckpt'
    ...
    def save_model(self,model_path=None):
        ...
        self.estimator.save(model_path+'/NSIAD.h5',save_format='h5')
        self.f_net.save(model_path+'/NSIAD_f.h5',save_format='h5')
        self.g_net.save(model_path+'/NSIAD_g.h5',save_format='h5')
        self.h_net.save(model_path+'/NSIAD_h.h5',save_format='h5')
    ...
    def load_model(self,model_path=None):
        ...
        if model_path is None:
            model_path = tempfile.gettempdir()
        self.estimator = keras.models.load_model(model_path+'/NSIAD.h5')
        self.f_net = keras.models.load_model(model_path+'/NSIAD_f.h5')
        self.g_net = keras.models.load_model(model_path+'/NSIAD_g.h5')
        self.h_net = keras.models.load_model(model_path+'/NSIAD_h.h5')
